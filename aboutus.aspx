     ...
     <html xmlns="http://www.w3.org/1999/xhtml">
       ...
       <li><a href="signin.aspx" id="signin" runat="server">Signin</a></li>
        ...
        <!-- //search-scripts -->
            ...
            <div id="center">            
                <h1 style="text-align:center">Super Motel</h1>
        <!-- <p><script>generateText(50)</script></p> -->
        <p> <img style="align-self:center" src="images/abt.jpg" alt="Super Motel Team" height="350" width="798"  padding="2em" border="2em bold black" /></p>
